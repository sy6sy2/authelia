...
3. The ability to create [custom attributes](#custom-attributes) to bolster the [custom claims] functionality.
...
identity_providers:
  oidc:
    claims_policies:
      default:
        id_token: ['scope', 'scp', 'client_id', 'groups', 'email', 'email_verified', 'alt_emails', 'preferred_username', 'name']
    clients:
      - client_id: 'client_example_id'
